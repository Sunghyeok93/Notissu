...
public class NoticeFragmentPagerAdapter extends FragmentStatePagerAdapter{
    ...
    public NoticeFragmentPagerAdapter(FragmentManager fm, int flag, String title, int tabCount, String[] tabStringList) {
        super(fm);
        this.mTitle = title;
    ...
    public Fragment getItem(int position) {
        ...
        return NoticeListFragment.newInstance(flag, mTitle, noticeRows);
    }
